<!-- views/form_customer.php -->
<?php ?>
<h3>Transaksi Customer</h3>
<form method="post">
    ...
    <input type="text" id="nama_customer" name="nama_customer" required value="<?= htmlspecialchars($_POST['nama_customer'] ?? '') ?>" />
    ...
    <button type="submit">Simpan Transaksi Customer</button>
</form>
